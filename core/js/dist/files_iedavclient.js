...
/******/ 	return __webpack_require__(__webpack_require__.s = "./core/src/files/iedavclient.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function(_) {/* eslint-disable */
...
(function (dav) {
  ...
  dav.Client.prototype = _.extend({}, dav.Client.prototype, {
     ...
     * @returns {Promise}
     */
    request: function request(method, url, headers, body) {
      var self = this;
      var xhr = this.xhrProvider();
      headers = headers || {};

      if (this.userName) {
        headers.Authorization = 'Basic ' + btoa(this.userName + ':' + this.password); // xhr.open(method, this.resolveUrl(url), true, this.userName, this.password);
      }
    ...
    _getElementsByTagName: function _getElementsByTagName(node, name, resolver) {
      var parts = name.split(':');
      var tagName = parts[1];
      var namespace = resolver(parts[0]); // make sure we can get elements
     ...
     * @param {Array}
     */
    parseMultiStatus: function parseMultiStatus(doc) {
      var result = [];
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! underscore */ "./node_modules/underscore/modules/index-all.js")))
